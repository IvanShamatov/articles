...
Хочешь узнать ещё больше? <br /> Запишись на обучение к автору!
</p>
...
<p class="notice clearfix">
<a href="https://mkdev.me/mentors/IvanShamatov" class="button pull-right" onClick="ga('send', 'event', 'article button', 'learn more');">Узнать подробности</a>
Автор этой статьи ведёт <br /> обучение основам Ruby on Rails
</p>
